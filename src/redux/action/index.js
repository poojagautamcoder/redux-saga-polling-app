...
export const AdduserRequest = createAction(constant.Adduser_Request);
export const AdduserSuccess = createAction(constant.Adduser_Success);
export const AdduserError = createAction(constant.Adduser_Error);
